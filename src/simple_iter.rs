    ...
    T: LevelMasks,
{
    ...
    level0_iter: <<T as LevelMasks>::Level0Mask as BitBlock>::BitsIter,
    level1_iter: <<T as LevelMasks>::Level1Mask as BitBlock>::BitsIter,
    level0_index: usize,
}
    ...
    T: LevelMasks
{
    ...
    pub fn new(container: &'a T) -> Self {
        let level0_iter = container.level0_mask().into_bits_iter();
        Self{
            container,
            level0_iter,
...
where
    T: LevelMasks,
{
    type Item = (usize/*index*/, <T as LevelMasks>::DataBlock);
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let block_index =
            self.level0_index << T::Level1Mask::SIZE_POT_EXPONENT
            + level1_index;
